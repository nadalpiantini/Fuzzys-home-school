...
const gameGenerators = {
  quiz: (subject: string, gradeLevel: number) => ({
    questions: [
      ...
      },
      {
        ...
        question:
          subject === 'math'
            ? 'Si tengo $250 y gasto $175, ¿cuánto me queda?'
        ...
        explanation:
          subject === 'math'
            ? '$250 - $175 = $75'
            : 'El Cruce de los Andes fue en 1817',
      },
      {
        id: '3',
        question:
          subject === 'math'
            ? '¿Cuál es el perímetro de un rectángulo de 8m × 5m?'
            : '¿Cuál es el río más largo de Argentina?',
        options:
          subject === 'math'
            ? ['26m', '13m', '40m', '32m']
            : ['Paraná', 'Uruguay', 'Colorado', 'Negro'],
        correct: 0,
        explanation:
          subject === 'math'
            ? 'Perímetro = 2(8+5) = 26m'
            : 'El río Paraná es el más largo de Argentina',
      },
    ],
  }),
  ...
  'word-search': (subject: string) => ({
    ...
    gridSize: 12,
    theme:
      subject === 'science' ? 'Conceptos de Ciencias' : 'Próceres Argentinos',
  }),
  ...
  crossword: () => ({
    ...
    clues: {
      ...
      vertical: [
        ...
        {
          number: 4,
          clue: 'Equipo de fútbol de La Boca',
          answer: 'BOCA',
          row: 1,
          col: 5,
        },
  ...
  puzzle: () => ({
    ...
    timeLimit: 300,
    hints: [
      'Empezá por los bordes',
      'Buscá las provincias grandes primero',
      'El norte es marrón por las montañas',
    ],
  }),
    ...
    events: [
      {
        ...
        description: 'Primer gobierno patrio',
      },
      {
        id: '2',
        year: 1816,
        title: 'Independencia',
        description: 'Declaración en Tucumán',
      },
      { id: '3', year: 1852, title: 'Caseros', description: 'Caída de Rosas' },
      {
        id: '4',
        year: 1880,
        title: 'Federalización',
        description: 'Buenos Aires capital federal',
      },
      {
        id: '5',
        year: 1912,
        title: 'Ley Sáenz Peña',
        description: 'Voto universal masculino',
      },
    ],
    startYear: 1800,
    endYear: 1920,
  ...
  'map-quiz': () => ({
    ...
    questions: [
      {
        id: '1',
        question: 'Señalá la provincia de Mendoza',
        answer: 'mendoza',
      },
      {
        id: '2',
        question: 'Señalá la provincia de Misiones',
        answer: 'misiones',
      },
      {
        id: '3',
        question: '¿Dónde está Tierra del Fuego?',
...
async function seedGames() {
  ...
  const games = [
    ...
    },
    {
      ...
      instructions:
        'Arrastra los eventos a su posición correcta en la línea de tiempo',
      time_limit: 360,
      points: 180,
    },
    {
  ...
  for (const game of games) {
    const { error } = await supabase.from('games').insert(game as any);
...
async function seedColonialRally() {
  ...
  const rallyPoints = [
    {
      ...
      challenge: {
        ...
        correct: 1,
        explanation:
          'El 9 de julio de 1816 se declaró la Independencia en San Miguel de Tucumán',
      },
      ar_content: {
        model: 'flag-3d',
        animation: 'wave',
      ...
      educational_content:
        'En esta casa, los representantes de las Provincias Unidas del Río de la Plata declararon la independencia de España y de toda dominación extranjera.',
      order_index: 1,
    },
    {
      ...
      educational_content:
        'El Cabildo fue el escenario de los acontecimientos de la Semana de Mayo de 1810, que culminaron con la formación del primer gobierno patrio.',
      order_index: 2,
    },
    {
      ...
      educational_content:
        'A orillas del río Paraná, Manuel Belgrano izó por primera vez la bandera celeste y blanca que se convertiría en símbolo nacional.',
      order_index: 3,
    },
    {
      ...
      educational_content:
        'En la Vuelta de Obligado, las fuerzas argentinas defendieron heroicamente la soberanía nacional contra la intervención anglo-francesa.',
      order_index: 4,
    },
    {
      name: 'Plaza de Mayo',
      ...
      educational_content:
        'La Plaza de Mayo ha sido testigo de los acontecimientos más importantes de la historia argentina, desde 1810 hasta la actualidad.',
      order_index: 5,
    },
    {
      ...
      educational_content:
        'El museo preserva la memoria de los 200 años de historia argentina a través de objetos, documentos y testimonios.',
      order_index: 6,
    },
    {
      ...
      educational_content:
        'La Quinta de Olivos ha sido residencia de los presidentes argentinos y escenario de importantes decisiones políticas.',
      order_index: 7,
    },
    {
      ...
      educational_content:
        'El cementerio alberga los restos de presidentes, escritores, científicos y otras figuras fundamentales de la historia argentina.',
      order_index: 8,
    },
    {
      name: 'Puerto Madero',
      ...
      educational_content:
        'Puerto Madero representa la transformación de Buenos Aires, desde su función portuaria colonial hasta convertirse en un moderno distrito.',
      order_index: 9,
    },
    {
      ...
      challenge: {
        ...
        correct: 0,
        explanation:
          'Argentina tiene 257 diputados y 72 senadores (3 por provincia)',
      },
      ar_content: {
        model: 'congreso-3d',
      ...
      educational_content:
        'El Congreso Nacional es donde se debaten y sancionan las leyes que rigen la vida de todos los argentinos.',
      order_index: 10,
    },
  ];
  ...
  for (const point of rallyPoints) {
    const { error } = await supabase.from('colonial_rally_points').insert({
      ...point,
...
async function seedAchievements() {
  ...
  for (const achievement of achievements) {
    ...
    if (error) {
      console.error(
        `Error inserting achievement "${achievement.name}":`,
        error,
      );
    } else {
...
async function main() {
  ...
  try {
    ...
    console.log(
      '📚 You can now use the educational games and Colonial Rally in your app.',
    );
  } catch (error) {
